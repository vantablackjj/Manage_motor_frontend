            ...
            <div className="print-invoice-container">
                ...
                <div className="header-flex">
                    <div className="logo-side">
                        ...
                        />
                        <div style={{ fontSize: '9pt', fontWeight: 'bold', marginTop: '5px' }}>
                            HEAD {warehouse.location || 'Ninh Bình'}
                        </div>
                    </div>
                    <div className="national-side">
                ...
                <div className="title-date">
                    {warehouse.location || 'Ninh Bình'}, ngày {dayjs(sale.sale_date).format('DD')} tháng {dayjs(sale.sale_date).format('MM')} năm {dayjs(sale.sale_date).format('YYYY')}
                </div>
                ...
                <div className="section-container">
                    ...
                    {/* BÊN BÁN */}
                    <div style={{ fontWeight: 'bold', marginTop: '5px' }}>1 - ĐẠI DIỆN BÊN BÁN XE (A) :</div>
                    <div className="info-row">
                        <div className="info-value" style={{ textTransform: 'uppercase' }}>
                            {warehouse.warehouse_name ? `${warehouse.warehouse_name} - ${warehouse.address || ''}` : '................................................................................................'}
                        </div>
                    </div>
                    <div className="info-row">
                        <div className="info-col">
                            <span className="info-label">Điện thoại :</span>
                            <span className="info-value">{warehouse.phone || '......................'}</span>
                        </div>
                        <div className="info-col">
                    ...
                    <div className="info-row">
                        <div className="info-col">
                            ...
                            <span className="info-value">{warehouse.manager_name || '......................'}</span>
                        </div>
                        <div className="info-col">
                    ...
                    {/* BÊN MUA */}
                    <div style={{ fontWeight: 'bold', marginTop: '10px' }}>2 - ĐẠI DIỆN BÊN MUA XE (B) :</div>
                    <div className="info-row">
                        <div className="info-col" style={{ flex: 1.5 }}>
                        ...
                        <div className="info-col">
                            ...
                            <span className="info-value">{sale.id_card || '................'}</span>
                        </div>
                    </div>
                    <div className="info-row">
                        <span className="info-label">Địa chỉ :</span>
                        <span className="info-value">{sale.address || '................................................................................'}</span>
                    </div>
                    <div className="info-row">
                        <span className="info-label">Điện thoại :</span>
                        <span className="info-value">{sale.phone || '......................'}</span>
                    </div>
                    <div className="info-row">
                        <span className="info-label">Người bảo lãnh :</span>
                        <span className="info-value">{sale.guarantor_name || '................................'}</span>
                    </div>

                    {/* NỘI DUNG */}
                    <div style={{ fontWeight: 'bold', marginTop: '10px' }}>3 - NỘI DUNG HỢP ĐỒNG :</div>
                    ...
                    <div className="info-row" style={{ marginTop: '5px' }}>
                        ...
                        <span className="info-value">{sale.sale_type === 'Đăng ký' ? 'Đăng ký xe' : 'Hồ sơ xe'}</span>
                    </div>
                    <div className="info-row">
                        <div className="info-col">
                            <span className="info-label">Loại xe :</span>
                            <span className="info-value">{vehicle.VehicleType?.name || '................'}</span>
                        </div>
                        <div className="info-col">
                            <span className="info-label">Màu :</span>
                            <span className="info-value">{vehicle.VehicleColor?.color_name || '................'}</span>
                        </div>
                    </div>
                    <div className="info-row">
                        <div className="info-col">
                            <span className="info-label">Số máy :</span>
                            <span className="info-value">{sale.engine_no || '................'}</span>
                        </div>
                        <div className="info-col">
                            <span className="info-label">Số khung :</span>
                            <span className="info-value">{sale.chassis_no || '................'}</span>
                        </div>
                    </div>
                    <div className="info-row" style={{ marginTop: '5px' }}>
                        <div className="info-col">
                            <span className="info-label">Giá bán :</span>
                            <span className="info-value">{Number(sale.sale_price).toLocaleString()} đ</span>
                        </div>
                        <div className="info-col">
                            <span className="info-label">Đã trả :</span>
                            <span className="info-value">{Number(sale.paid_amount).toLocaleString()} đ</span>
                        </div>
                    </div>
                    <div className="info-row">
                        <span className="info-label">Còn nợ lại :</span>
                        <span className="info-value" style={{ fontSize: '12pt' }}>{debt.toLocaleString()} đ</span>
                    </div>
                    <div className="info-row">
                        <span className="info-label">Bằng chữ :</span>
                        <span className="info-value" style={{ fontStyle: 'italic' }}>{numberToWords(debt)} .</span>
                    </div>

                    <div style={{ marginTop: '5px' }}>
                        Hẹn đến ngày ....... tháng ....... năm 20....... , Ông (Bà) <span style={{ fontWeight: 'bold' }}>{sale.customer_name}</span> phải trả hết số tiền còn nợ cho công ty chúng tôi và nhận Đăng ký xe .
                    </div>

                    <div className="footer-text">
                        - Nếu quá hạn thanh toán 1 tháng khách hàng phải chịu lãi suất 3%/tháng.<br />
                        - Nếu quá hạn thanh toán 2 tháng tôi xin chịu chấp nhận cho công ty thu hồi xe và xin chịu mọi phí tổn hao mòn xe, bồi thường cho <span style={{ fontWeight: 'bold', textTransform: 'uppercase' }}>{warehouse.warehouse_name || 'CÔNG TY'}</span>.<br />
                        (Tôi xin cam kết thực hiện nghiêm chỉnh hợp đồng trên. Nếu sai tôi xin chịu hoàn toàn trách nhiệm trước pháp luật.)
                    </div>

                    <div className="info-row" style={{ marginTop: '5px' }}>
                        <span className="info-label" style={{ fontWeight: 'bold' }}>Ghi chú :</span>
                ...
                <div className="signature-flex">
                    <div className="sig-box">
                        ...
                        <div className="sig-name" style={{ marginTop: '35px' }}>{sale.customer_name}</div>
                    </div>
                    <div className="sig-box">
                        <div className="sig-title">Người bảo lãnh</div>
                        <div className="sig-guide">(Ký và ghi rõ họ tên)</div>
                        <div className="sig-name" style={{ marginTop: '35px' }}>{sale.guarantor_name || ''}</div>
                    </div>
                    <div className="sig-box">
                        <div className="sig-title">Đại diện bên bán xe</div>
                        <div className="sig-guide">(Ký và đóng dấu)</div>
                        <div className="sig-name" style={{ marginTop: '35px' }}>{warehouse.manager_name || ''}</div>
                    </div>
                </div>
            </div>
        </div>

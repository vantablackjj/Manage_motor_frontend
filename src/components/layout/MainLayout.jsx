...
const MainLayout = ({ children }) => {
  ...
  useEffect(() => {
    ...
    socket.on("notification_new", (noti) => {
      ...
      try {
        ...
        audio
          .play()
          .catch((e) => console.warn("Audio play auto-blocked by browser"));
      } catch (e) {}
    });
  ...
  const renderNotificationList = (isMobileView = false) => {
    return (
      <div style={{ display: "flex", flexDirection: "column", height: "100%", maxHeight: isMobileView ? "calc(100vh - 120px)" : 400 }}>
                ...
                >
                  <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                    {n.Warehouse && (
                      ...
                      >
                        {n.Warehouse.warehouse_name}
                      </Tag>
                    )}
                    {n.creator && (
                      <Text style={{ fontSize: 10, color: "#64748b" }}>
                        bởi {n.creator.full_name}
                      </Text>
                    )}
                  </div>
                  {!n.is_read && (
  ...
  const notificationMenu = (
    <Card
      title={
        <Space>
          <Bell size={18} /> Thông báo công việc
        </Space>
      }
      size="small"
      style={{
  ...
  const canManageMaster =
    ...
    user.can_manage_master_data === 1;
  const canManageSales =
    isAdmin ||
    isManager ||
    user.can_manage_sales === true ||
    user.can_manage_sales === 1;
  const canManageSpareParts =
    isAdmin ||
    isManager ||
    user.can_manage_spare_parts === true ||
    user.can_manage_spare_parts === 1;
  const canManageExpenses =
    isAdmin ||
    user.can_manage_expenses === true ||
    user.can_manage_expenses === 1;
  const canManageDebt =
      ...
      children: [
        {
          ...
          children: [
            { key: "/retail", label: <Link to="/retail">Bán lẻ xe máy</Link> },
            {
              ...
              label: (
                <Link to="/wholesale">
                  {canManageDebt ? "Bán buôn & Thu nợ" : "Dữ liệu bán buôn"}
                </Link>
              ),
            },
            {
              key: "/purchase",
              label: <Link to="/purchase">Nhập xe mua & Trả tiền</Link>,
            },
            {
              key: "/transfers",
              label: <Link to="/transfers">Chuyển kho chi nhánh</Link>,
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              children: [
                {
                  key: "/report/sales-retail",
                  label: <Link to="/report/sales-retail">Xe bán lẻ</Link>,
                },
                {
                  key: "/report/sales-wholesale",
                  label: <Link to="/report/sales-wholesale">Xe bán buôn</Link>,
                },
                {
                  key: "/report/wholesale-audit",
                  label: (
                    <Link to="/report/wholesale-audit">
                      Đối soát khách buôn
                    </Link>
                  ),
                },
            ...
            },
            {
              ...
              label: <Link to="/report/purchases">Nhật ký mua xe</Link>,
            },
            {
              key: "/inventory-report",
              label: <Link to="/inventory-report">Xem xe tồn kho</Link>,
            },
            {
              key: "/report/warranty",
              label: <Link to="/report/warranty">Danh sách xe bảo hành</Link>,
            },
            {
              key: "/vehicle-search",
              label: <Link to="/vehicle-search">Tìm xe theo yêu cầu</Link>,
            },
          ],
        },
      ].filter(Boolean),
      ...
      children: [
        {
          ...
          children: [
            {
              key: "/part-retail",
              label: <Link to="/part-retail">Bán lẻ phụ tùng</Link>,
            },
            {
              key: "/part-wholesale",
              label: <Link to="/part-wholesale">Bán buôn phụ tùng</Link>,
            },
            {
              key: "/part-import",
              label: <Link to="/part-import">Nhập mua phụ tùng</Link>,
            },
            {
              key: "/part-transfer",
              label: <Link to="/part-transfer">Luân chuyển phụ tùng</Link>,
            },
            canManageDebt && {
              key: "pts-debt-folder",
              ...
              children: [
                {
                  key: "/part-retail-debt",
                  label: <Link to="/part-retail-debt">Nợ bán lẻ</Link>,
                },
                {
                  key: "/part-wholesale-debt",
                  label: <Link to="/part-wholesale-debt">Nợ mua sỉ</Link>,
                },
              ],
            },
          ],
        },
        {
          ...
          children: [
            {
              key: "/maintenance-hub",
              label: <Link to="/maintenance-hub">Trung tâm Bảo trì (Hub)</Link>,
            },
            {
              key: "/maintenance-rules",
              icon: <ClipboardList size={16} />,
              label: (
                <Link to="/maintenance-rules">Thiết lập gợi ý bảo trì</Link>
              ),
            },
            {
              key: "/report/maintenance",
              label: <Link to="/report/maintenance">Nhật ký xe vào xưởng</Link>,
            },
          ],
        },
        {
          ...
          children: [
            {
              key: "/report/parts-sales",
              label: <Link to="/report/parts-sales">Nhật ký bán lẻ PT</Link>,
            },
            {
              key: "/report/parts-wholesale",
              label: (
                <Link to="/report/parts-wholesale">Nhật ký bán buôn PT</Link>
              ),
            },
            {
              key: "/report/parts-purchases",
              label: (
                <Link to="/report/parts-purchases">Nhật ký nhập mua PT</Link>
              ),
            },
            {
              key: "/report/parts-usage",
              label: (
                <Link to="/report/parts-usage">Chi tiết xuất phụ tùng</Link>
              ),
            },
            {
              key: "/part-inventory",
              label: <Link to="/part-inventory">Tồn kho phụ tùng</Link>,
            },
          ],
        },
      ].filter(Boolean),
    ...
    // --- QUẢN TRỊ HỆ THỐNG ---
    {
      ...
      children: [
        canManageExpenses && {
          key: "/expenses",
          icon: <Wallet size={16} />,
          label: <Link to="/expenses">Quản lý chi tiêu</Link>,
        },
        isAdmin && {
          key: "/employees",
          icon: <Users size={16} />,
          ...
          children: [
            {
              ...
              children: [
                {
                  key: "/suppliers",
                  label: <Link to="/suppliers">Nhập chủ hàng (NCC)</Link>,
                },
                {
                  key: "/wholesale-customers",
                  label: (
                    <Link to="/wholesale-customers">
                      Danh mục khách buôn xe
                    </Link>
                  ),
                },
                {
                  key: "/vehicle-types",
                  label: <Link to="/vehicle-types">Đăng ký loại xe</Link>,
                },
              ],
            },
            {
              ...
              children: [
                {
                  key: "/parts",
                  label: <Link to="/parts">Đăng ký mã phụ tùng</Link>,
                },
                {
                  key: "/part-locations",
                  label: <Link to="/part-locations">Sơ đồ vị trí kho</Link>,
                },
                {
                  key: "/part-wholesale-customers",
                  label: (
                    <Link to="/part-wholesale-customers">
                      Đăng ký khách sỉ PT
                    </Link>
                  ),
                },
                {
                  key: "/gifts",
                  label: <Link to="/gifts">Quản lý quà tặng</Link>,
                },
              ],
            },
            {
              ...
              children: [
                {
                  key: "/mechanics",
                  label: <Link to="/mechanics">Danh sách thợ sửa</Link>,
                },
                {
                  key: "/warehouses",
                  label: <Link to="/warehouses">Quản lý kho hàng</Link>,
                },
              ],
            },
          ],
        ...
        isAdmin && {
          key: "/system/backups",
          icon: <Archive size={16} />,
          label: <Link to="/system/backups">Sao lưu & Phục hồi</Link>,
        },
      ].filter(Boolean),
    },
  ].filter(Boolean);
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout>
                  ...
                  <Button
                    ...
                    icon={
                      <Bell
                        size={22}
                        color={
                          unreadCount > 0 ? "var(--primary-color)" : "#1e1b4b"
                        }
                      />
                    }
                  />
        ...
        <Content className="main-content-area">
          <div className="glass-card main-card-container">{children}</div>
        </Content>
        <style>{`
            .main-content-area {
                margin: 16px;
